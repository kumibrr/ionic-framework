...
export const createSheetGesture = (
  ...
  const SheetDefaults = {
    ...
    CONTAINER_KEYFRAMES: [
      ...
      { offset: 0.1, transform: 'scaleY(0.9)' },
      { offset: 0.2, transform: 'scaleY(0.8)' },
      { offset: 0.3, transform: 'scaleY(0.7)' },
      { offset: 0.4, transform: 'scaleY(0.6)' },
      { offset: 0.5, transform: 'scaleY(0.5)' },
      { offset: 0.6, transform: 'scaleY(0.4)' },
      { offset: 0.7, transform: 'scaleY(0.3)' },
      { offset: 0.8, transform: 'scaleY(0.2)' },
      { offset: 0.9, transform: 'scaleY(0.1)' },
      { offset: 0.95 , transform: 'scaleY(0.05)' },
      { offset: 1, transform: 'scaleY(0)' },
    ],
    CONTENT_KEYFRAMES: [
      { offset: 0, transform: 'scaleY(1)' },
      { offset: 0.1, transform: 'scaleY(1.11111111)' },
      { offset: 0.2, transform: 'scaleY(1.25)' },
      { offset: 0.3, transform: 'scaleY(1.33333333)' },
      { offset: 0.4, transform: 'scaleY(1.66666666)' },
      { offset: 0.5, transform: 'scaleY(2)' },
      { offset: 0.6, transform: 'scaleY(2.5)' },
      { offset: 0.7, transform: 'scaleY(3.33333333)' },
      { offset: 0.8, transform: 'scaleY(5)' },
      { offset: 0.9, transform: 'scaleY(10)' },
      { offset: 0.95, transform: 'scaleY(20)' },
      { offset: 1, transform: 'scaleY(0)' },
    ],
  };
